...
from model import EfficientNet, MBConvBlock
from utils import get_model_params, MemoryEfficientSwish
...
class FiLMBlock(nn.Module):
    def __init__(self, base_block):
        ...
        # self.film = FiLM(base_block._depthwise_conv.conv2d.in_channels, base_block._depthwise_conv.conv2d.out_channels)
