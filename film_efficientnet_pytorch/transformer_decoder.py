...
class Transformers_Decoder(nn.Module):
    def __init__(self, dim, depth, heads, dim_head, mlp_dim, dropout = 0., d_model = 512, max_seq_len = 48, num_actions = 11, vocab_size = 256):
        super().__init__()
...
if __name__ == '__main__':
    ...
    # model = Transformers_Decoder(dim=4096, depth=8, heads=8, dim_head=512, mlp_dim=512, dropout = 0., d_model = 512, max_seq_len = 48, num_actions = 11, vocab_size = 256)
    model = Transformers_Decoder(dim=512, depth=8, heads=8, dim_head=64, mlp_dim=512, dropout = 0., d_model = 512, max_seq_len = 48, num_actions = 11, vocab_size = 256)
