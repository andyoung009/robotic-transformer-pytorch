...
# # 从 site 包含的文件夹列表中移除指定文件夹
# unwanted_folder_path = '/LOG/realman/LLM/robotics_transformer'
# if unwanted_folder_path in site.getsitepackages():
#     site.removepackage(unwanted_folder_path)
